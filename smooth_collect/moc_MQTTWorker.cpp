...
QT_MOC_LITERAL(3, 21, 14), // "publishMessage"
QT_MOC_LITERAL(4, 36, 7), // "message"
QT_MOC_LITERAL(5, 44, 4) // "stop"

    },
    "MQTTWorker\0finished\0\0publishMessage\0"
    "message\0stop"
};
...
void MQTTWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MQTTWorker::finished)) {
                *result = 0;
                return;
            }
        }
